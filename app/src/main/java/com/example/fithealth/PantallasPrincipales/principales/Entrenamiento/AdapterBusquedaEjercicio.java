...
public class AdapterBusquedaEjercicio extends RecyclerView.Adapter<ViewHolderBuscarEjercicio>{

    List<BuscarEjercicioData> data;
    ...
    public AdapterBusquedaEjercicio(List<BuscarEjercicioData> data) {
        this.data = data;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolderBuscarEjercicio holder, int position) {
        ...
        BuscarEjercicioData item = data.get(position);
